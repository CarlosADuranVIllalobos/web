...
def tcellmodel(y, t, us, F_air, rgvar, bivar): #ODE Model 
    ...
    #Constant rates
    Co = 20      #Glucose concentration in the the feeding vessel [mg/mL]
...
def control_tcell(model,hours,us,variability):
    ...
    Y0 = np.array ([1.1e6, 0, 1, -24, 50, 100, 7.4 ]) #[viable cells, dead cells, glucose c.,Inhibitor, Volume, DO, pH]
    viab = variability [0]
    Y0[1] = Y0[0]*(1-viab)
    Y0[0] = Y0[0]*viab
